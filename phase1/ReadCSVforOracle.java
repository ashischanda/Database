...
/// It will read three file to insert data in three tables of Oracle DB 
...
public class ReadCSVforOracle {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String line = "";
        String cvsSplitBy = ",";
        DBoracleConnect obj = new DBoracleConnect();
        ...
        //*********************************************************************
        int counter = 0;        // We need to close oracle after 500 query execution
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                counter++;
                if(counter%500==0){
                    obj.closeConnection();      // close Oracle 
                    obj.openConnection();       // Restart again the connection
                }
            }
